...
struct ss5g_boot_command {
	u32 type;
	u32 addr;
	u32 value;
} __packed;

struct ss5g_boot_data {
	u32 type;
	// unsigned long long binary;
	u8 *binary;
	u32 len;
...
struct link_device {
	...
	int (*init_descriptor)(struct link_device *ld);
...
struct modem_ctl {
	...
	const char *regulator_ldo3;
	const char *regulator_ldo4;
	const char *regulator_ldo5;
	const char *regulator_ldo11;
	const char *regulator_ldo12;
	const char *regulator_ldo13;
	const char *regulator_ldo14;
	const char *regulator_ldo15;
	const char *regulator_ldo16;
	const char *regulator_ldo17;
