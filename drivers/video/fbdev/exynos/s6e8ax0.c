...
static int s6e8ax0_set_power(struct lcd_device *ld, int power)
{
	...
	{
		/* LCD power on */
		if ((POWER_IS_ON(power) && POWER_IS_OFF(lcd->power)) || (POWER_IS_ON(power) && POWER_IS_NRM(lcd->power)))
		{
