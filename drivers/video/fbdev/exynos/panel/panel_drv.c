...
int panel_probe(struct panel_device *panel)
{
	...
	rt_mutex_lock(&panel->panel_bl.lock);
	...
	rt_mutex_unlock(&panel->panel_bl.lock);
...
#endif
	rt_mutex_init(&panel->op_lock);
	rt_mutex_init(&panel->data_lock);
	rt_mutex_init(&panel->io_lock);
	rt_mutex_init(&panel->panel_bl.lock);
	rt_mutex_init(&panel->mdnie.lock);
	rt_mutex_init(&panel->copr.lock);
